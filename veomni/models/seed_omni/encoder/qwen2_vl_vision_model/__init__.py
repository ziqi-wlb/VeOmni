...
AutoConfig.register("qwen2_vl_vision_model", Qwen2VLVisionModelConfig)
AutoModel.register(Qwen2VLVisionModelConfig, Qwen2VLVisionModel)
AutoProcessor.register(Qwen2VLVisionModelConfig, Qwen2VLVisionModelProcessor)
